...
public class JNIPort {
	...
	public static native void setCamera(float cx, float cy, float cz,
			float upx, float upy, float upz);

	public static native void loadObjData(int objId, float[] vertices,
			int numsVer, float[] normals, int numsNor);
