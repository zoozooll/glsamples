...
import static com.bn.Sample12_2.ShaderUtil.createProgram;
...
{	
    ...
    public CameraBackDrawer(MySurfaceView mv,float widthHalf,float heightHalf)
    {    	
    	//初始化顶点数据的方法
    ...
    {
    	//加载顶点着色器的脚本内容
        mVertexShader=ShaderUtil.loadFromAssetsFile("vertex_back.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("frag_back.sh", mv.getResources());  
        //基于顶点着色器与片元着色器创建程序
