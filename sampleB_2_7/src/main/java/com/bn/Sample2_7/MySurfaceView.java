...
class MySurfaceView extends GLSurfaceView 
{
    ...
    {  
        ...
        { 
            ...
            MatrixState.translate(0f, 0f, -15f);//执行平移
        ...
        {  
            ...
            //加载要绘制的物体
            lovo=LoadUtil.loadFromFile("zd.obj", MySurfaceView.this.getResources(),MySurfaceView.this);
            //加载纹理  
            textureId=initTexture(R.drawable.zd_bg);
        }
    }  
