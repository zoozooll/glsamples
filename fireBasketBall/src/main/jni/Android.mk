...
LOCAL_SRC_FILES := \
        ...
        view/AboutView.cpp \
        view/SetView.cpp \
        view/LoadingView.cpp \
        view/RecordView.cpp \
        FireBasketBallcpp/main.cpp \
        MyBullet/Ball.cpp \
        MyBullet/TexBall.cpp \
        MyBullet/TextureRect.cpp \
        MyBullet/TexCuboid.cpp \
        MyBullet/TexTriangleMesh.cpp \
        MyBullet/AnyShapeByVectices.cpp \
        MyBullet/Digital.cpp \
        MyBullet/SoftObj.cpp \
        util/SYSUtil.cpp \
        SQLiteUtil/SQLiteUtil.cpp \
        SQLiteUtil/sqlite3.c \
        FireBasketBallcpp/jni_code.c

LOCAL_ARM_MODE   := arm 
LOCAL_CFLAGS := $(LOCAL_C_INCLUDES:%=-I%) -O3 -DANDROID_NDK -DDISABLE_IMPORTGL 
#LOCAL_ALLOW_UNDEFINED_SYMBOLS := true
LOCAL_LDLIBS := -ldl -llog -lGLESv3 -landroid -lm -ljnigraphics
