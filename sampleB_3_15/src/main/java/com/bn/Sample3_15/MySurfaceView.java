...
import static com.bn.Sample3_15.ParticleDataConstant.COUNT;
import static com.bn.Sample3_15.ParticleDataConstant.CURR_INDEX;
import static com.bn.Sample3_15.ParticleDataConstant.RADIS;
    ...
    {   
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) 
        {
            ...
            for(int i=0;i<count;i++)
            {
            	...
            	CURR_INDEX=i;
            	fpfd[i]=new ParticleForDraw(MySurfaceView.this,RADIS[CURR_INDEX]);  
            	//创建对象,将火焰的初始位置传给构造器
