...
class MySurfaceView extends GLSurfaceView 
{
    ...
    {
        int[] ids = new int[1];//用于存储生成的纹理编号的数组
        GLES30.glGenTextures(1, ids, 0);//生成一个新的纹理编号
        int cubeMapTextureId = ids[0];
        
        GLES30.glBindTexture(GLES30.GL_TEXTURE_CUBE_MAP, cubeMapTextureId); //绑定纹理    
        //设置纹理采样方式、拉伸方式
