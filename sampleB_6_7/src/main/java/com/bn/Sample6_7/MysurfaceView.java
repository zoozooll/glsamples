...
public class MysurfaceView extends GLSurfaceView{
	...
	LoadedObjectVertexNormalTexture goalObj;
	LoadedObjectVertexNormalTexture ballObj;
	...
	private class SceneRenderer implements GLSurfaceView.Renderer
	{
		...
		public void onDrawFrame(GL10 gl) {
			...
			MatrixState.pushMatrix();
			MatrixState.translate(ballP.x, ballP.y, ballP.z);
			ballObj.drawSelf(ballTextureId);
			...
			MatrixState.pushMatrix();
			footgoal.darwSelf(goalTextureId);
			MatrixState.popMatrix();
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            goalObj=LoadUtil.loadFromFile("goal.obj",MysurfaceView.this.getResources(),MysurfaceView.this);
            ballObj=LoadUtil.loadFromFile("ball.obj",MysurfaceView.this.getResources(),MysurfaceView.this);
            footgoal=new Goal(MysurfaceView.this, goalObj);
            
            goalTextureId=initTexture(R.drawable.goal,MysurfaceView.this);
