...
public class GL2JNIView extends GLSurfaceView
{
	...
	private class SceneRenderer implements GLSurfaceView.Renderer
	{
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config)
		{
			...
			LoadUtil.loadFromFileWd("chahu.obj", GL2JNIView.this.getResources());
	        JNIPort.loadObjDataWd(6, LoadUtil.m_vertices, LoadUtil.m_numsVer, LoadUtil.m_indices, LoadUtil.m_numsInd,
	      		  					LoadUtil.m_tex, LoadUtil.m_numsTex);
	         
	        LoadUtil.loadFromFileWd("yuanhuan.obj", GL2JNIView.this.getResources());
	        JNIPort.loadObjDataWd(5, LoadUtil.m_vertices, LoadUtil.m_numsVer, LoadUtil.m_indices, LoadUtil.m_numsInd,
	      		  					LoadUtil.m_tex, LoadUtil.m_numsTex);
			
          LoadUtil.loadFromFileWd("ruanguan.obj", GL2JNIView.this.getResources());
          JNIPort.loadObjDataWd(4, LoadUtil.m_vertices, LoadUtil.m_numsVer, LoadUtil.m_indices, LoadUtil.m_numsInd,
        		  					LoadUtil.m_tex, LoadUtil.m_numsTex);
		}
	}
	@Override
