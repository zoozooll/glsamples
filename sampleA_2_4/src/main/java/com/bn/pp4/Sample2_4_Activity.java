...
public class Sample2_4_Activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) { // 重新onCreate方法
		...
		Button b = (Button) this.findViewById(R.id.Button01); // 获取打开/创建数据库按钮的引用
		...
		b = (Button) this.findViewById(R.id.Button02);// 获取关闭数据库按钮的引用
		...
		b = (Button) this.findViewById(R.id.Button03); // 获取添加记录按钮的引用
		...
		b = (Button) this.findViewById(R.id.Button04);// 获取删除记录按钮的引用
		...
		b = (Button) this.findViewById(R.id.Button05); // 获取查询记录按钮的引用
