...
public class GL2JNIView extends GLSurfaceView
{
	...
	private class SceneRenderer implements GLSurfaceView.Renderer
	{
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config)
		{
          ...
          LoadUtil.loadFromFileWd("ruanguan.obj", GL2JNIView.this.getResources());
          JNIPort.loadObjDataWd(1, LoadUtil.m_vertices, LoadUtil.m_numsVer, LoadUtil.m_indices, LoadUtil.m_numsInd,
        		  null,0);
			
//          LoadUtil.loadFromFileWd("cube.obj", GL2JNIView.this.getResources());
//          JNIPort.loadObjDataWd(3, LoadUtil.m_vertices, LoadUtil.m_numsVer, LoadUtil.m_indices, LoadUtil.m_numsInd,
//        		  					LoadUtil.m_tex, LoadUtil.m_numsTex, LoadUtil.m_indices_tex, LoadUtil.m_numsInd_tex);
			
          LoadUtil.loadFromFileWd("yuanhuan.obj", GL2JNIView.this.getResources());
          JNIPort.loadObjDataWd(2, LoadUtil.m_vertices, LoadUtil.m_numsVer, LoadUtil.m_indices, LoadUtil.m_numsInd,
        		  null,0);
          
			
//          LoadUtil.loadFromFile("table.obj", GL2JNIView.this.getResources());
//          JNIPort.loadObjData(0, LoadUtil.m_vertices, LoadUtil.m_numsVer, LoadUtil.m_normals, LoadUtil.m_numsNor);
//          
//          LoadUtil.loadFromFile("yh.obj", GL2JNIView.this.getResources());
//          JNIPort.loadObjData(1, LoadUtil.m_vertices, LoadUtil.m_numsVer, LoadUtil.m_normals, LoadUtil.m_numsNor);
//          
//          LoadUtil.loadFromFile("ch.obj", GL2JNIView.this.getResources());
//          JNIPort.loadObjData(2, LoadUtil.m_vertices, LoadUtil.m_numsVer, LoadUtil.m_normals, LoadUtil.m_numsNor);
		}
	}
	@Override
