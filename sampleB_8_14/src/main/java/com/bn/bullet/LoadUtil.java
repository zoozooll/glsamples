...
public class LoadUtil 
{
	...
	public static int m_numsVer;
	public static int m_numsNor;
	public static int[] m_indices;
	public static int m_numsInd;
	
	//从obj文件中加载携带顶点信息的物体，并自动计算每个顶点的平均法向量
	//获取顶点数据，顶点索引数据  并不计算平均法向量
...
//    	LoadedObjectVertexNormal lo=null;
	...
	//从obj文件中加载携带顶点信息的物体，并自动计算每个顶点的平均法向量
    public static void loadFromFile(String fname, Resources r)
    {
    	//加载后物体的引用
//    	LoadedObjectVertexNormal lo=null;
    	//原始顶点坐标列表--直接从obj文件中加载
...
//		    m_numsIndex = numsIndex;
//		    m_index = index;
		    
//		    //创建3D物体对象
//		    lo=new LoadedObjectVertexNormal(vXYZ,nXYZ);
		    m_vertices = vXYZ;
		    m_numsNor = vXYZ.length;
		    
		    m_normals = nXYZ;
			m_numsVer = nXYZ.length;
    	}
    	catch(Exception e)
    	{
    		Log.d("load error", "load error");
