...
public class MySurfaceView extends GLSurfaceView 
{
  ...
  public boolean onTouchEvent(MotionEvent e) 
  {
	...
	private class SceneRenderer implements GLSurfaceView.Renderer 
    {
        ...
        {
        	//设置视口大小
			GLES30.glViewport(0,0,TEXTURE_WIDTH,TEXTURE_HEIGHT);		
			//设置镜像摄像机的9参数
			...
			drawThings();			//绘制场景
			GLES30.glBindTexture(GLES30.GL_TEXTURE_2D, mirrorId);//绑定纹理
			//从颜色缓冲区复制数据到纹理
			GLES30.glCopyTexImage2D(GLES30.GL_TEXTURE_2D, 0, GLES30.GL_RGB8, 0, 0,1024, 1024, 0);
        }
